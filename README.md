...
So if you use for example the tab-row-per-project-feature TabSwitch will not jump between different tab-rows like the build-in NetBeans IDE feature does.
