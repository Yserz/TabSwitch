...
public class TabSwitchImpl implements TabSwitch {
    ...
    /**
     * Returns the last TopComponent tab of the upper project group from the currently focused TopComponent.
     *
     * @return
        ...
        if (openTabs.size() > 0) {
            ...
            if (prevEntry != null) {
                ...
                if (upperProjectTabs.isEmpty()) {
                    LOG.log(Level.WARNING, "TabGroup of upper project {0} is empty!", new Object[]{prevEntry.getKey().
                        getProjectDirectory()});
                } else {
    ...
    /**
     * Returns the first TopComponent tab of the below project group from the currently focused TopComponent.
     *
        ...
        if (openTabs.size() > 0) {
            ...
            if (belowProjectEntry != null) {
                ...
                if (belowProjectTabs.isEmpty()) {
                    LOG.log(Level.WARNING, "TabGroup of below project {0} is empty!", new Object[]{belowProjectEntry.getKey().
                        getProjectDirectory()});
                } else {
     ...
     * @throws NoRelatedProjectFoundException if no project is related to the given TopComonent.
     */
